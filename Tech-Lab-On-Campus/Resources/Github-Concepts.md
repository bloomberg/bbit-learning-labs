...
### Get changes from origin/main to local main
...
### Rebase against local main

```bash
# local main => local my-new-feature
git checkout my-new-feature
git rebase main
```

### Push your changes to prepare for pull-request

```bash
# local my-new-feature => origin/my-new-feature
